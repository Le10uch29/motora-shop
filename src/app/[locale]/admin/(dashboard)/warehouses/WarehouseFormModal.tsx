...
import { createWarehouseAction, updateWarehouseAction, type WarehouseActionState } from "./actions";
...
const initialState: WarehouseActionState = { error: null };
      ...
      >
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-50">
            {mode === "create" ? dict.addWarehouse : dict.editWarehouse}
          </h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="warehouse-name" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
            {dict.warehouseNameLabel}
          </label>
          <input
            id="warehouse-name"
            name="name"
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="warehouse-address" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
            {dict.warehouseAddressLabel}
          </label>
          <input
