...
export default function HeaderSearch({
  ...
  return (
    <div className="flex w-full items-center gap-2">
      <form ref={searchFormRef} onSubmit={handleSearchSubmit} role="search" className="relative min-w-0 flex-1">
        ...
        {suggestions.open && (
          <SearchSuggestionsDropdown
            ...
            viewAllHref={`/${locale}/catalog?q=${encodeURIComponent(query.trim())}`}
          ...
          <div className="fixed inset-0 z-40 flex items-start justify-center overflow-y-auto bg-black/40 px-4 py-16">
            ...
            >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  value={filters.make}
                  onChange={(event) => setFilters((f) => ({ ...f, make: event.target.value, model: "" }))}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  onChange={(event) => setFilters((f) => ({ ...f, model: event.target.value }))}
                  className="rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50"
                >
